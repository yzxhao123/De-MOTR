...
class Detector(object):
    ...
    def write_results(txt_path, frame_id, bbox_xyxy, identities):
        save_format = '{id},{frame},{x1},{y1},{w},{h},1,-1,-1,-1\n'
...
if __name__ == '__main__':
    ...
    all_seq_nums = os.listdir('/root/autodl-tmp/data1/datasets/data_path/MOT17/images/train')
    seq_nums = [seq for seq in all_seq_nums if
                os.path.isdir(os.path.join('/root/autodl-tmp/data1/datasets/data_path/MOT17/images/train', seq))]
    accs = []
    seqs = []

    for seq_num in seq_nums:
        src_file = os.path.join(args.mot_path, sub_dir, f'{seq_num}/gt/gt.txt')
        dst_file = os.path.join(predict_path, f'{seq_num}.txt')
