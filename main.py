...
def get_args_parser():
    ...
    parser.add_argument('--bbox_loss_coef', default=6, type=float)
    ...
    parser.add_argument('--mot_path', default='/root/autodl-tmp/data1/datasets/data_path', type=str)
    parser.add_argument('--input_video', default='figs/demo.mp4', type=str)
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/data_path/mot17.train', type=str,
                        help="path to dataset txt split")
    parser.add_argument('--data_txt_path_val',
                        default='./datasets/data_path/mot17.train', type=str,
                        help="path to dataset txt split")
    parser.add_argument('--img_path', default='/root/autodl-tmp/data1/datasets/data_path/MOT17/images')
