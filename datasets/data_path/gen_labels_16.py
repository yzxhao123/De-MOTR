...
seq_root = '/root/autodl-tmp/data1/datasets/data_path/MOTanimal/images/test'
label_root = '/root/autodl-tmp/data1/datasets/data_path/MOTanimal/labels_with_ids/test'
mkdirs(label_root)
...
for seq in seqs:
    ...
    for row in gt:
        fid, tid, x, y, w, h, mark, _, _ = row[:9]
        if mark == 0:
            continue
